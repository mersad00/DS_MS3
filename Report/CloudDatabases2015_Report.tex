...
%average & median & min & max    & error \% & Throughput/sec \\
%97661   & 106326 & 309 & 195389 & 0        &               
%\end{tabular}
%\end{table}
\centering
     \includegraphics[width=0.5\textwidth]{graph-1.png}
%table two
\centering
...
%table
\centering
     \includegraphics[width=0.5\textwidth]{graph-3.png}

%table
\centering
     \includegraphics[width=0.5\textwidth]{graph-4.png}
 
\subsubsection{Test case3: ( 1000 clients, 10 servers, 20 s ramp-up time)}

%table
\centering
     \includegraphics[width=0.5\textwidth]{graph-5.png}
 
%table
\centering
     \includegraphics[width=0.5\textwidth]{graph-6.png}
 
\subsubsection{Test case4: ( 1000 clients, 10 servers, 20 s ramp-up time) without saving after each put request}
%table
\centering
     \includegraphics[width=0.5\textwidth]{graph-7.png}
 
%table
\centering
     \includegraphics[width=0.5\textwidth]{graph-8.png}
